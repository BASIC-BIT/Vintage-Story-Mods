...
```powershell
gh api repos/BASIC-BIT/vs-build-dependencies/contents/1.22.7 --jq '.[].name'
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File "scripts\upload-vs-dependencies.ps1" -VsInstallPath "D:\Games\Vintagestory" -VsVersion "1.22.7"
```
...
git commit -m "Update CI to Vintage Story 1.22.7 dependencies"
```
