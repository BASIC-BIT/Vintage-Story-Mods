...
$projectFile = Join-Path $projectRoot "dimensioncavern.csproj"
...
"[$timestamp] Cavern Dimension Demo package script started" | Out-File -FilePath $logFile
...
$msg = "Successfully created Cavern Dimension Demo package at $zipFile"
