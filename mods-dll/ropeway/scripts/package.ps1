...
$projectFile = Join-Path $projectRoot "ropeway.csproj"
...
"[$timestamp] Cable Car package script started" | Out-File -FilePath $logFile
...
$msg = "Successfully created Cable Car package at $zipFile"
