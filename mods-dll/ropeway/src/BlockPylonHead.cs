...
/// <summary>
/// The tower's controller block: the metal brace with the sheave loop that the haul rope runs over.
/// Owns the interaction state machine and the break-time refund. Validation is server side; the
...
public class BlockPylonHead : Block
{
    ...
    {
        var be = world.BlockAccessor.GetBlockEntity(blockSel.Position) as BEPylonHead;
    ...
    public override void OnBlockBroken(IWorldAccessor world, BlockPos pos, IPlayer byPlayer, float dropQuantityMultiplier = 1f)
    {
        ...
        var be = world.BlockAccessor.GetBlockEntity(pos) as BEPylonHead;
    ...
    public override WorldInteraction[] GetPlacedBlockInteractionHelp(IWorldAccessor world, BlockSelection selection, IPlayer forPlayer)
    {
        ...
        var be = world.BlockAccessor.GetBlockEntity(selection.Position) as BEPylonHead;
