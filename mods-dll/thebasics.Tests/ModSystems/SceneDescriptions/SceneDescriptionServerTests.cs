...
public class SceneDescriptionServerTests
{
    ...
    public void AcceptedAppearanceIsRememberedOnlyForFreshMarkers()
    {
        ...
        { Title = "Old title", Body = "Old body", Color = (int)SceneMarkerColor.Blue, HeightOffset = 3, IndicatorScale = 2, TextDistance = 5, IdleBobbing = false, ShowBodyInBubble = true, BubbleScale = 1.5f, TitleIcon = 6,
