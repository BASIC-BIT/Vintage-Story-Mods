...
public static class ConfigAdminSettingRegistry
{
    ...
    private static void AddScalarSettings(List<ConfigAdminSettingDefinition> settings)
    {
        settings.AddRange(new[]
        {
            ...
            Bool("EnableRpCharacterSlots", "Characters", "Enable RP character slots", "Enable RP character slots.", ConfigAdminReloadBehavior.RestartRequired, c => c.EnableRpCharacterSlots, (c, v) => c.EnableRpCharacterSlots = v),
            ...
            Bool("EnableRpCharacterFullSwitching", "Characters", "Full character switching", "Opt in to switching vanilla appearance, inventory, body state, position, spawn, and death count in addition to RP identity.", ConfigAdminReloadBehavior.RestartRequired, c => c.EnableRpCharacterFullSwitching, (c, v) => c.EnableRpCharacterFullSwitching = v),
            Bool("EnableRpCharacterAppearanceSwitching", "Characters", "Switch appearance", "Switch character class, traits, skin, voice, and skin model when full switching is enabled.", ConfigAdminReloadBehavior.RestartRequired, c => c.EnableRpCharacterAppearanceSwitching, (c, v) => c.EnableRpCharacterAppearanceSwitching = v),
            Bool("EnableRpCharacterInventorySwitching", "Characters", "Switch inventory", "Switch hotbar, backpack, and equipped character inventory when full switching is enabled.", ConfigAdminReloadBehavior.RestartRequired, c => c.EnableRpCharacterInventorySwitching, (c, v) => c.EnableRpCharacterInventorySwitching = v),
            Bool("EnableRpCharacterBodySwitching", "Characters", "Switch body state", "Switch health, hunger, intoxication, position, spawn, and death count when full switching is enabled.", ConfigAdminReloadBehavior.RestartRequired, c => c.EnableRpCharacterBodySwitching, (c, v) => c.EnableRpCharacterBodySwitching = v),
