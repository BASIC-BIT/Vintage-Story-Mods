...
public static class ConfigAdminSettingRegistry
{
    ...
    private static void AddCoreScalarSettings(List<ConfigAdminSettingDefinition> settings)
    {
        settings.AddRange(new[]
        {
            ...
            Bool("UseBasicConfigAdminUi", "Diagnostics", "Use BasicConfig admin UI", "Use the shared BasicConfig admin editor for this config panel. The legacy editor remains available when disabled.", ConfigAdminReloadBehavior.Live, c => c.UseBasicConfigAdminUi, (c, v) => c.UseBasicConfigAdminUi = v),
