...
public static class ConfigAdminSettingRegistry
{
    ...
    private static void AddScalarSettings(List<ConfigAdminSettingDefinition> settings)
    {
        settings.AddRange(new[]
        {
            ...
            Bool("EnableRpCharacterFullSwitching", "Characters", "Full character switching", "Switch vanilla appearance, inventory, body state, position, spawn, and death count in addition to RP identity.", ConfigAdminReloadBehavior.RestartRequired, c => c.EnableRpCharacterFullSwitching, (c, v) => c.EnableRpCharacterFullSwitching = v),
