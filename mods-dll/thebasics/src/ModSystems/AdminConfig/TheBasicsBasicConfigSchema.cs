...
internal static class TheBasicsBasicConfigSchema
{
    ...
    private static void AddCoreScalarSettings(List<BasicConfigSettingDefinition<ModConfig>> settings)
    {
        settings.AddRange(new[]
        {
            ...
            Bool("Teleportation.TopRequireTemporalGear", "Home/Spawn", "Top requires temporal gear", "Require a temporal gear for /top teleports. Checked before warmup and consumed only when the teleport completes.", BasicConfigReloadBehavior.Live, c => Teleportation(c).TopRequireTemporalGear, (c, v) => Teleportation(c).TopRequireTemporalGear = v),
